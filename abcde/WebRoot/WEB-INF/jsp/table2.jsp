...
<body>
  ...
  <div class="top-bar">
      <ul id="nav">       
        ...
        <ul id="top-nav">        
         <li class="nav-item">
           <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitFormtotables()"><img src="../img/nav/tb-active.png" alt="" /><p>表格</p></a>
         </li>
         <li class="nav-item">
  ...
  <div class="content container_12">
      <div class="box grid_12">
        <div class="box-head"><h2>统计</h2></div>
        <div class="box-content no-pad">
         ...
         <a download="somedata.xls" href="#" onclick="return ExcellentExport.excel(this, 'datatable', 'Sheet Name Here');">导出 Excel</a>
         --><!--<a download="somedata.csv" href="#" onclick="return ExcellentExport.csv(this, 'datatable');">Export to CSV</a>
        --></div>
      </div>
  
      <div class="box grid_12">
        <div class="box-head"><h2>所有原因</h2></div>
        <div class="box-content no-pad"> 
      ...
      <div class="box grid_12">
        <div class="box-head"><h2>邻区参数配置/容量参数/License问题</h2></div>
        <div class="box-content no-pad">
      ...
      <div class="box grid_12">
        <div class="box-head"><h2>其他原因</h2></div>
        <div class="box-content no-pad">
...
<script> /* SCRIPTS */
  ...
  function submitForm(){
				window.location.href="getpci.do";
			}  
  function submitFormtobioge(){
				window.location.href="tubiao.do";
			}  
  function  submitFormtotables(){
