...
<body>
  ...
  <div class="top-bar" >
      <ul id="nav">       
        ...
        <ul id="top-nav">        
         ...
         <li class="nav-item">
           <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitFormtobioge()"><img src="../img/nav/grid.png" alt="" /><p>网格</p></a>
         </li> 
         <!--<li class="nav-item">
  ...
  <!--- CONTENT AREA -->
                ...
                <form id="searchForm" action="<%=path%>/user/getAll3.do" method="post" onsubmit="return checkForm();">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-cell">
                        <tbody>
                            <tr>
                                <th >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日期：</th>
                                <td>
                                        <input type="text" name="datepicker" id="datetimepicker3" class="form-control" value="2017-9-20"/>
                                        &nbsp;&nbsp;&nbsp;&nbsp; 时间：
                                        <input type="text" name="datepicker" id="datetimepicker1" class="form-control" value="8:00"/>
                                        &nbsp;&nbsp;至    
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group float-left w140">
                                                                                                 地区：
                                    <select name="selectAge" id="selectAge" style="width:115px;">   
                                    <option value="1">南昌</option>   
                                    <option value="2">九江</option>   
                                    <option value="3">赣州</option>   
                                    <option value="4">宜春</option>   
                                    <option value="5">吉安</option>
                                    <option value="6">抚州</option>   
                                    </select>
                                   
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;N1门限值：
                                    <input id="N1" name="N1"  type="text" style="width:116px;" />
                                    &nbsp;&nbsp;RRC重建比例(%)门限值：
                                    <input id="RRC" name="RRC "  type="text" style="width:40px;" />
                                    </div>
                                </td>
                                <td></td>
                                <td>
                                <input type="submit" onclick="userLogin()"  value="查询" style="width:50px;height:30px;"/>
                                </td>                               
  ...
  <div class="content container_12">
      <div class="box grid_12">
        <div class="box-head"><h2>结果</h2></div>
        <div class="box-content no-pad">
        <table class="display" id="dt3" id="tableExcel">
        <thead>
          <tr>
                   <th>基站ID</th>
                   <th>小区ID</th>
        ...
        <tbody>
          <c:forEach var="row" items="${list}">
                <tr>
                   ...
                   <td><a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitForm()"><c:out value="查看"/></a></td>
               </tr>
               </c:forEach>     
        </tbody>
      </table>
